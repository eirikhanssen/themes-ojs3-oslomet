{**
 * lib/pkp/templates/frontend/components/header.tpl ==> plugins/themes/RadOpen/templates/frontend/components/header.tpl
 *
...
{strip}
	...
	{/if}
	{assign var="titleHTML" value='<div class="headertext">Radiography <span class="highlight">Open</span></div>'}
{/strip}
<!DOCTYPE html>
