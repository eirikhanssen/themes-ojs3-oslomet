{**
 * lib/pkp/templates/frontend/components/header.tpl ==> plugins/themes/NJAR/templates/frontend/components/header.tpl
 *
...
{strip}
	...
	{/if}
	{assign var="titleHTML" value='<div class="headertext"><div class="header_njar"><span class="header_njof">Nordic Journal of </span><span class="header_anr">Art &amp; Research</span></div></div>'}
{/strip}
<!DOCTYPE html>
