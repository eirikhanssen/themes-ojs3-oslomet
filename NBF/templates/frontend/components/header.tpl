{**
 * lib/pkp/templates/frontend/components/header.tpl ==> plugins/themes/NBF/templates/frontend/components/header.tpl
 *
...
{strip}
	...
	{/if}
	{assign var="titleHTML" value='<div class="headertext"><span class="title_nb_NO"><span class="abbrev">N</span>ordisk <span class="abbrev">B</span>arnehage<span class="abbrev">f</span>orskning</span><span class="title_en_US">Nordic Early Childhood Education Research</span></div>'}
{/strip}
<!DOCTYPE html>
