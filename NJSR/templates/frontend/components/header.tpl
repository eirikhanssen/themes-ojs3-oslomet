{**
 * lib/pkp/templates/frontend/components/header.tpl ==> plugins/themes/NJSR/templates/frontend/components/header.tpl
 *
...
{strip}
	...
	{/if}
	{assign var="titleHTML" value='<div class="headertext"><span class="abbrev">NJSR</span><span class="nordic">NORDIC JOURNAL of</span><span class="social">SOCIAL RESEARCH</span></div>'}
{/strip}
<!DOCTYPE html>
