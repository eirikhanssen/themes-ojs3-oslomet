...
/**
 * @file plugins/themes/SJVD/SJVDThemePlugin.inc.php
 *
 * Copyright (c) 2014-2017 Simon Fraser University
 * Copyright (c) 2003-2017 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class SJVDThemePlugin
 * @ingroup plugins_themes_SJVD
 *
 * @brief SJVD theme
 */
...
class SJVDThemePlugin extends ThemePlugin {
	...
	function getDisplayName() {
		return __('plugins.themes.SJVD.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.SJVD.description');
	}
}
